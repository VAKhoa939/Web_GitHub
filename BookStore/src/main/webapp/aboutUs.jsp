	...
	<div class= "row">
		<div class="creator">
			...
			<div>
				...
				<a href ="https://www.facebook.com/anhkhoa.vo.939" target="_blank">
					<ion-icon name="logo-facebook" height = 10%></ion-icon>
				</a>
			</div>
		</div>
		<div class="creator">
			...
			<div>
				...
				<a href ="https://www.facebook.com/peter.cao.161/" target="_blank">
